#Problem Statement
#In this problem, you will build a Decision Tree model that uses statistics of images 
#of four letters in the Roman alphabet -- A, B, P, and R -- to predict which letter 
#a particular image corresponds to. 
